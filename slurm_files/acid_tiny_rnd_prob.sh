...
# Code execution
srun python3 -m src.main +experiment=acid exp_name=${EXP_NAME} hydra.run.dir=${RUN_DIR} trainer.devices=4 trainer.num_nodes=1 data_loader.train.batch_size=1 wandb.mode=offline wandb.tags=[acid,256x256,prob_sampling] checkpointing.every_n_train_steps=10000
