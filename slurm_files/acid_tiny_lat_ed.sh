...
#SBATCH --output=slurm_logs/acid_tiny_lat_ed_%j.output   # name of output file
#SBATCH --error=slurm_logs/acid_tiny_lat_ed_%j.error     # name of error file (here, in common with the output file)
