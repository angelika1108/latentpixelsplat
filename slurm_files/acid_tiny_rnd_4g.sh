#!/bin/bash
#SBATCH --job-name=acid_tiny_rnd_4g               # name of job
...
#SBATCH --output=slurm_logs/acid_tiny_rnd_4g_%j.output   # name of output file
#SBATCH --error=slurm_logs/acid_tiny_rnd_4g_%j.error     # name of error file (here, in common with the output file)
