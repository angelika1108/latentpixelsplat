#!/bin/bash
#SBATCH --job-name=med_bs1_gpu1  # name of job
...
#SBATCH --output=slurm_logs/med_bs1_gpu1_%j.output   # name of output file
#SBATCH --error=slurm_logs/med_bs1_gpu1_%j.error     # name of error file (here, in common with the output file)
